...
async function getBotResponseFromOpenRouter(message) {
    ...
    const apiKey = "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";
        ...
        const response = await fetch(`${baseUrl}/chat/completions`, {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    {
                        role: "system",
                       //content: "Você é uma IA desenvolvida para normalizar as frases segundo a língua gestual angolana as regras são as seguintes: Verbos devem estar sempre no infinitivo se eles estiverem no futuro ou passado coloca no infinitivo e adiciona advérbios ou coisa do gênero para manter o sentido. O mesmo para os adjectivos devem estar sempre no grau normal. És livre para pesquisar mais sobre essa lógica. No final retorna apenas a frase modificada. És uma IA para NLP. Exemplo de verbo[está, estava, estarei, estando =>estar]. Quando o verbo conjugado estiver no inicio da frase adiciona um sujeito correspondente e coloca o verbo no infinitivo nesse em em outros casos necessários não esquce de adicionar o advérbio de tempo para complementar (ex: depois, mais tarde, antes etc...)"
